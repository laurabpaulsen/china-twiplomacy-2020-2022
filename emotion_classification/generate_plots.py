...
if __name__ == '__main__':
    # Plotting emotions
    df = pd.read_csv(os.path.join('data', 'emotion_diplomat_data.csv'))
    ...
    for i, dat in enumerate([df, df_no_rt]):
        ...
        plot_all_grid(dat, save_path = os.path.join('fig', f'all_emotions{rt}_normalised.png'), normalize=True)
        plot_all_grid(dat, save_path = os.path.join('fig', f'all_emotions{rt}.png'), normalize=False)

        #plot_emotions(dat, f'fig/emotions{rt}_normalised.png', normalize=True)
        #plot_emotions(dat, f'fig/all_emotions{rt}_normalised.png', normalize=False)
        ...
        plot_all_grid(dat_nov, save_path = os.path.join('fig', 'november_and_forth', f'all_emotions{rt}_normalised.png'), normalize=True)
        plot_all_grid(dat_nov, save_path = os.path.join('fig','november_and_forth', f'all_emotions{rt}.png'), normalize=False)

        #plot_emotions(dat_nov, f'fig/november_and_forth/emotions{rt}_normalised.png', normalize=True)
        #plot_emotions(dat_nov, f'fig/november_and_forth/all_emotions{rt}_normalised.png', normalize=False)
    ...
    for i, file in enumerate(['emotions_summarised_date_no_rt', 'emotions_summarised_date']):
        ...
        plot_fluxus(flux, filename = f'fluxus{rt}.png', gaussian = [6, 40][i])
        ...
        plot_fluxus(flux_may, filename = f'may_to_november/fluxus{rt}.png')
        ...
        plot_fluxus(flux_nov, filename = f'november_and_forth/fluxus{rt}.png')
